...
const { listSubmissions, gradeSubmission, bulkGrade } = require('../controllers/instructor.submissions.controller');
...
const { checkPlagiarism, getPlagiarism, updatePlagiarism } = require('../controllers/instructor.plagiarism.controller');
